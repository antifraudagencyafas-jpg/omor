                ...
                <li>
                  <details className="group" open>
                    ...
                    <ul className="bg-white px-6 py-3 space-y-3 border-t border-slate-100">
                      <li>
                        <Link href="/products/screw-pumps/omt-vs150-viscous-handling-single-screw-pump" className="block text-sm text-blue-600 font-medium">
                          OMT-VS150 Viscous Handling Single Screw Pump
                        </Link>
                      </li>
                      <li>
                        <Link href="/products/screw-pumps/omt-gp200-general-purpose-single-screw-pump" className="block text-sm text-slate-500 hover:text-blue-600">
