...
**Learning:** Next.js build processes (especially those using SWC or Babel) can fail with cryptic syntax errors when React components exported from page files use hyphens in their names (e.g., `OMC-HC 280Page`). React components must follow PascalCase conventions.
