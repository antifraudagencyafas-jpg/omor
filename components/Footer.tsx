      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/products/omc-centrifugal-pumps" className="text-slate-400 hover:text-blue-500 transition-colors">OMC Centrifugal Pumps</Link></li>
              <li><Link href="/products/screw-pumps" className="text-slate-400 hover:text-blue-500 transition-colors">Screw Pumps</Link></li>
              <li><Link href="/products/water-pumps" className="text-slate-400 hover:text-blue-500 transition-colors">Water Pumps</Link></li>
              ...
              <li><Link href="/products/solar-pumps" className="text-slate-400 hover:text-blue-500 transition-colors">Solar Pumps</Link></li>
            </ul>
          </div>
          ...
          <div id="contact">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center">
                  <Mail className="w-4 h-4 text-blue-500 mr-3 flex-shrink-0" />
                  <span className="text-slate-400 text-sm">export@omrontechpumps.nl</span>
                </li>
              </ul>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center">
                  <Mail className="w-4 h-4 text-blue-500 mr-3 flex-shrink-0" />
                  <span className="text-slate-400 text-sm">operations@omrontechpumps.nl</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800 text-center md:text-left flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            ...
            <Link href="/sitemap.xml" className="text-slate-500 hover:text-white transition-colors">Sitemap</Link>
          </div>
        </div>
      </div>
    </footer>
