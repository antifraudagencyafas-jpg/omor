  ...
  return (
    <div className="bg-blue-600 text-white text-sm py-2 px-4 md:px-8 flex flex-col sm:flex-row justify-between items-center z-50 relative">
      <div className="flex items-center space-x-6 mb-2 sm:mb-0">
        <a href="tel:+3197010238786" className="flex items-center space-x-2 hover:text-blue-200 transition-colors">
          <Phone className="w-4 h-4 text-white" />
          <span>+3197010238786</span>
        </a>
        <a href="mailto:sales@omrontechpumps.nl" className="flex items-center space-x-2 hover:text-blue-200 transition-colors">
